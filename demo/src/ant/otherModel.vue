    ...
    setup() {
        ...
        rule.value = [
            ...
            },
            {
                ...
                field: "collapse",
                children: [
                    { type: 'a-collapse-panel', props: { header: '第 1 步', key: '1' }, children: ['第 1 步内容'] },
                    { type: 'a-collapse-panel', props: { header: '第 2 步', key: '2' }, children: ['第 2 步内容'] },
                    { type: 'a-collapse-panel', props: { header: '第 3 步', key: '3' }, children: ['第 3 步内容'] },
                    { type: 'a-collapse-panel', props: { header: '第 4 步', key: '4' }, children: ['第 4 步内容'] },
                ],
                vModelKey: 'activeKey',
            },
            {
                ...
                field: "tabs",
                children: [
                    { type: 'a-tab-pane', props: { tab: '第 1 步', key: '1' }, children: ['第 1 步内容'] },
                    { type: 'a-tab-pane', props: { tab: '第 2 步', key: '2' }, children: ['第 2 步内容'] },
                    { type: 'a-tab-pane', props: { tab: '第 3 步', key: '3' }, children: ['第 3 步内容'] },
                ],
                value: '1',
                vModelKey: 'activeKey',
            },
